(custom-set-variables
 ...
 '(eglot-ignored-server-capabilities '(:codeActionProvider :inlayHintProvider))
 ...
 '(org-agenda-files '("/Users/jacobwong/roamBank/20260202202309-tasks.org"))
 ...
 '(package-selected-packages
   '(arduino-mode cape corfu-prescient doom-themes doric-themes eat
                  ef-themes eglot eglot-booster emacsql embark-consult
                  emmet-mode exec-path-from-shell flx flycheck-eglot
                  go-mode god-mode gruber-darker-theme hl-todo magit
                  marginalia meow modus-themes nano-agenda nano-theme
                  orderless org-appear org-bullets org-download
                  org-hyperscheduler pdf-tools projectile python-mode
                  request rust-mode simple-httpd smartparens surround
                  typst-preview undo-tree vertico-prescient vterm
                  vundo web-server which-key xterm-color yasnippet))
 '(package-vc-selected-packages
   '((lambda-themes :vc-backend Git :url
 ...
 '(sh-shell-file "/opt/homebrew/bin/zsh")
 '(shell-file-name "/opt/homebrew/bin/zsh")
